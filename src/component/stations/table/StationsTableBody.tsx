            ...
            <TableBody>
                {props.stations.map((station: StationForTable) =>
                    <TableRow key={station.id}>
                        ...
                        <TableCell className={styles.tableCell_body}>{station.type.label}</TableCell>
                        <TableCell className={styles.tableCell_body}>{station.planet.label}</TableCell>
                        <TableCell className={styles.tableCell_body}>{station.user.label}</TableCell>
                        ...
                        <TableCell className={styles.tableCell_body}>
                            <Link to={`/stations/${station.id}`}>Edit Station</Link>
                        </TableCell>
                    </TableRow>
                )}
            </TableBody>
